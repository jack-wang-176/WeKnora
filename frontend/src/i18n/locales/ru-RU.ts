export default {
  ...
  settings: {
    ...
    plugins: {
      title: 'Плагины расширений',
      description: 'Расширения источников данных, обработки документов и веб-поиска',
      scopeTenant: 'Текущее пространство',
      scopeProcess: 'Всё развёртывание',
      refresh: 'Обновить',
      install: 'Установить',
      register: 'Зарегистрировать',
      submit: 'Сохранить',
      emptyDesc: 'Плагинов пока нет',
      enabled: 'Вкл',
      disabled: 'Выкл',
      reconnect: 'Переподключить',
      envsTitle: 'Переменные окружения',
      envsTip: 'Значения не возвращаются. Сохранение заменяет весь набор.',
      envKey: 'Имя',
      envValue: 'Значение',
      addEnv: 'Добавить переменную',
      uninstall: 'Удалить',
      uninstallConfirm: 'Удалить плагин {name}?',
      envKeys: 'Переменных: {n}',
      kind: 'Тип',
      transport: 'Транспорт',
      endpoint: 'Адрес',
      policy: 'Сетевая политика',
      pluginId: 'ID плагина',
      pluginIdTip: 'Базовый ID из манифеста, без суффикса пространства',
      sourceType: 'Тип источника',
      sourceUrl: 'Адрес источника',
      sourceRef: 'Версия / ссылка',
      manifest: 'Манифест',
      manifestTip: 'Вставьте манифест плагина (YAML)',
      registerTitle: 'Регистрация плагина',
      ...
      kind_websearch: 'Веб-поиск',
      kind_docparser: 'Разбор документов',
      kind_datasource: 'Источник данных',
      kind_docreader: 'Чтение документов',
      externalPolicy: 'Внешний сервис',
      health_serving: 'Работает',
      health_not_serving: 'Ошибка сервиса',
      health_not_configured: 'Не настроен',
      health_unknown: 'Состояние неизвестно',
      health_unavailable: 'Недоступен',
      health_notfound: 'Не загружен',
      health_disabled: 'Отключён',
      envValueRequired: 'Введите новые значения сохраняемых переменных или удалите ненужные.',
