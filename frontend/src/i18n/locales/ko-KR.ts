export default {
  ...
  settings: {
    ...
    plugins: {
      title: '확장 플러그인',
      description: '데이터 소스, 문서 파서 및 웹 검색 확장',
      scopeTenant: '현재 워크스페이스',
      scopeProcess: '전체 배포',
      refresh: '새로고침',
      install: '설치',
      register: '등록',
      submit: '저장',
      emptyDesc: '플러그인이 없습니다',
      enabled: '켜짐',
      disabled: '꺼짐',
      reconnect: '재연결',
      envsTitle: '환경 변수',
      envsTip: '값은 다시 표시되지 않으며, 저장하면 전체가 교체됩니다.',
      envKey: '이름',
      envValue: '값',
      addEnv: '변수 추가',
      uninstall: '제거',
      uninstallConfirm: '플러그인 {name}을(를) 제거할까요?',
      envKeys: '변수 {n}개',
      kind: '종류',
      transport: '전송',
      endpoint: '주소',
      policy: '네트워크 정책',
      pluginId: '플러그인 ID',
      pluginIdTip: '매니페스트의 기본 ID, 워크스페이스 접미사 제외',
      sourceType: '소스 유형',
      sourceUrl: '소스 주소',
      sourceRef: '버전 / 참조',
      manifest: '매니페스트',
      manifestTip: '플러그인 매니페스트(YAML)를 붙여넣으세요',
      registerTitle: '플러그인 등록',
      installTitle: '플러그인 설치',
      missingFields: '필수 항목을 입력하세요',
      loadFailed: '플러그인 목록을 불러오지 못했습니다',
      actionFailed: '작업에 실패했습니다',
      kind_websearch: '웹 검색',
      kind_docparser: '문서 파싱',
      kind_datasource: '데이터 소스',
      kind_docreader: '문서 리더',
      externalPolicy: '외부 서비스',
      health_serving: '정상',
      health_not_serving: '서비스 오류',
      health_not_configured: '미설정',
      health_unknown: '상태 알 수 없음',
      health_unavailable: '사용 불가',
      health_notfound: '로드되지 않음',
      health_disabled: '비활성화',
      envValueRequired: '유지할 변수의 새 값을 입력하거나 사용하지 않는 변수를 삭제하세요.',
