export default {
  ...
  settings: {
    ...
    plugins: {
      ...
      description: 'Data source, document parser and web search extensions',
      scopeTenant: 'This workspace',
      scopeProcess: 'Whole deployment',
      refresh: 'Refresh',
      install: 'Install',
      register: 'Register',
      submit: 'Save',
      emptyDesc: 'No plugins yet',
      enabled: 'On',
      disabled: 'Off',
      reconnect: 'Reconnect',
      envsTitle: 'Environment variables',
      envsTip: 'Values are never read back. Saving replaces the whole set.',
      envKey: 'Name',
      envValue: 'Value',
      addEnv: 'Add variable',
      uninstall: 'Uninstall',
      uninstallConfirm: 'Uninstall plugin {name}?',
      envKeys: '{n} variable(s)',
      kind: 'Kind',
      transport: 'Transport',
      endpoint: 'Endpoint',
      policy: 'Network policy',
      pluginId: 'Plugin ID',
      pluginIdTip: 'Base ID from the manifest, without the workspace suffix',
      sourceType: 'Source type',
      sourceUrl: 'Source address',
      sourceRef: 'Version / ref',
      manifest: 'Manifest',
      manifestTip: 'Paste the plugin manifest (YAML)',
      registerTitle: 'Register a plugin',
      installTitle: 'Install a plugin',
      missingFields: 'Fill in the required fields',
      loadFailed: 'Failed to load plugins',
      actionFailed: 'Operation failed',
      kind_websearch: 'Web search',
      kind_docparser: 'Document parser',
      kind_datasource: 'Data source',
      kind_docreader: 'Document reader',
      externalPolicy: 'External service',
      health_serving: 'Healthy',
      health_not_serving: 'Unhealthy',
      health_not_configured: 'Not configured',
      health_unknown: 'Health unknown',
      health_unavailable: 'Unavailable',
      health_notfound: 'Not loaded',
      health_disabled: 'Disabled',
      envValueRequired: 'Enter new values for retained variables, or remove unused variables.',
