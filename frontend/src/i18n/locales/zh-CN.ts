export default {
  ...
  settings: {
    ...
    plugins: {
      ...
      reconnect: '重连',
      envsTitle: '环境变量',
      envsTip: '变量值不会回显，保存会整体替换。',
      envKey: '名称',
      envValue: '值',
      addEnv: '新增变量',
      uninstall: '卸载',
      uninstallConfirm: '确认卸载插件 {name}？',
      envKeys: '{n} 个变量',
      kind: '类型',
      transport: '传输',
      endpoint: '地址',
      policy: '网络策略',
      pluginId: '插件 ID',
      pluginIdTip: 'manifest 中的基础 ID，不含空间后缀',
      sourceType: '来源类型',
      sourceUrl: '来源地址',
      sourceRef: '版本 / 引用',
      manifest: 'Manifest',
      manifestTip: '粘贴插件 manifest（YAML）',
      registerTitle: '登记插件',
      installTitle: '安装插件',
